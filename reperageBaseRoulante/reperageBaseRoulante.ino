...
const int n1=100;
const int n2=100;
float alpha = PI/100; // Angle entre le repère de la première souris et celui de la deuxième.
 
PS2MouseEgab mouse1(pinHorloge1,pinData1,n1);// définition des deux objets souris
PS2MouseEgab mouse2(pinHorloge2,pinData2,n2);

ReperageSouris souris = ReperageSouris(&mouse1, &mouse2, alpha, largeur);
