...
Robot monRobot = Robot(&moteurGauche,&moteurDroit, 105, 40); //roue gauche, roue droite, empattement, rayon roue
...
/*  pinMode(codeurGauche1,INPUT);
  ...
  */
  ...
  monRobot.initLeds();
  //monRobot.jeuLeds();
  moteurDroit.tourneRPM(0);
  moteurGauche.tourneRPM(0);
}
...
void loop() 
{
  ...
  monRobot.avancerTourner(10,2);
  monRobot.actualiserPosition();
  //monRobot.suivrePoint(1,0,0.05);
